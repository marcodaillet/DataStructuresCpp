...
/*   Updated: 2022/04/26 14:32:35 by mdaillet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class RB_tree
{
	public: // Defining the variables type we need to creat a RB_tree
		...
		typedef RBTree_Iter<Content, node<Content> > 				iterator;
		typedef RBTree_Iter<const Content, node<Content> > 			const_iterator;
