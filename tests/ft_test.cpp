...
/*   Updated: 2022/04/23 12:44:44 by mdaillet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_test(void)
{
	std::ofstream of("output/ft_output.txt");
	of << "\x1B[31m!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! \n";
	of << "!!!!!!      INT TESTING          !!!!!! \n";
	of << "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! \033[0m\n\n";
	...
	for (int i = 0; i < 8; i++)
		ma1.insert(ft::make_pair(range_int[i], range_str[i]));
	...
	of << "Range constructor.\n";
	for (int i = 0; i < 8; i++)
		m_s1.insert(ft::make_pair(mran_s[i], mran_str[i]));
	...
	for (int i = 0; i < 8; i++)
		m_s5.insert(ft::make_pair(ran2_string[i], ran2_str2[i]));
	print_map(of, m_s5);

	of << "Inserting a simple pair banane0 : test at a precise pos 0 : \n";
	m_s5.insert(m_s5.begin(), ft::make_pair("banane0", "test"));
	print_map(of, m_s5);
