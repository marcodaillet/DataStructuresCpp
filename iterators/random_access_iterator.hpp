...
/*   Updated: 2022/02/21 20:05:48 by mdaillet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	template<typename L>class random_access_iterator
	{
		public:
	...
	template<typename L>
	random_access_iterator<L> operator +(const typename random_access_iterator<L>::difference_type & a, random_access_iterator<L> & iter)
	{
		return	(iter + a);
	}
	template<typename L>
	random_access_iterator<L> operator -(const typename random_access_iterator<L>::difference_type & a, const random_access_iterator<L> & iter)
	{
		return	(iter - a);
	}
}
